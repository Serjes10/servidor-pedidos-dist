    ...
    MostrarAdjunto(parametros) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield conexionSQL.Ejecutar("call spAdjuntosMostrar(?)");
            }
            catch (error) {
    ...
    EliminarAdjunto(parametros) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield conexionSQL.Ejecutar("call spAdjuntosEliminar(?,?)");
            }
            catch (error) {
                return (0, classes_1.errorMensaje)("");
            }
...
exports.default = AdjuntosController;
